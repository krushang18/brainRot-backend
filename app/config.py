...
BREVO_FROM_NAME = os.getenv("BREVO_FROM_NAME", "BrainRot")
...
GOOGLE_CALLBACK_URL = os.getenv("GOOGLE_CALLBACK_URL", "https://localhost:8000/auth/google/callback")
...
MAX_NOTE_IMAGES = int(os.getenv("MAX_NOTE_IMAGES", "5"))
